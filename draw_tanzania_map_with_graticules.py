...
# !pip install --upgrade geopandas shapely fiona matplotlib-scalebar cartopy
...
boundary_path = "tanzania_regions/tanzania_regions.shp"
...
merged_gdf.plot(column='Enrolment Coefficient', cmap='OrRd', linewidth=0.8, ax=ax, edgecolor='0.8', legend=True, transform=ccrs.PlateCarree())

# Plot the Tanzania international boundary
tanzania_boundary.plot(ax=ax, edgecolor='black', facecolor='none', linewidth=1.5, transform=ccrs.PlateCarree())
